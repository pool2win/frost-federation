    ...
    fn call(&mut self, mut msg: Message) -> Self::Future {
        ...
        Box::pin(async move {
            ...
            match response_message {
                Ok(Some(msg)) => {
                    debug!("Sending echo broadcast with message {:?}", msg);
                ...
                _ => {
                    info!("No response to send for received broadcast");
                    Ok(())
                }
            }
        })
